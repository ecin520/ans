...
public class VerificationController {
	...
	public JSONObject insertVerification(@RequestBody Verification verification) {
		...
		if (verificationService.insertVerification(verification)) {
			return JsonObject.backStatus(200, "发送验证成功！");
		} else {
			return JsonObject.backStatus(500, "发送验证失败！");
		}
	...
	public JSONObject updateVerificationsStatus(@RequestBody Verification verification) {
		...
		if ( verificationService.updateVerificationsStatus(verification) ) {
			return JsonObject.backStatus(200, "OK！");
		} else {
